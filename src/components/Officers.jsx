...
const OfficerCardColor = (props) => {
    return (
      <>
      <div className='flex flex-col items-center w-80 p-5'>
          <div className='bg-red-600 w-full p-5 flex flex-col rounded-t'>
          ...
          <div className='leading-tight bg-black p-5 rounded-b h-96 w-full'> 
              {props.officer.description}
          </div>
      </div>
      </>
